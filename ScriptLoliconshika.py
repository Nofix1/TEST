...
from pyrogram.types import Dice
...
colorama.init()
print(Fore.GREEN + Style.BRIGHT + ">>> Руководство по авторизации в скрипте @TPAXHYLCYKYss")
print("")
...
Script От Лоликонщика(@TPAXHYLCYKY)
print(Fore.RED + Style.BRIGHT +'''				v0.0.1
''')
